...
class BuyersControllerTest < ActionController::TestCase
  ...
  test "should create buyer" do
    assert_difference('Buyer.count') do
      post :create, buyer: { avatar: @buyer.avatar, city: @buyer.city, country: @buyer.country, name: @buyer.name, quantity: @buyer.quantity, shipped: @buyer.shipped }
    end
  ...
  test "should update buyer" do
    patch :update, id: @buyer, buyer: { avatar: @buyer.avatar, city: @buyer.city, country: @buyer.country, name: @buyer.name, quantity: @buyer.quantity, shipped: @buyer.shipped }
    assert_redirected_to buyer_path(assigns(:buyer))
  end
